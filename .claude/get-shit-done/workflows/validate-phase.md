...
```
Agent(
  prompt="Read /Users/suryaps/Documents/Hackathons/allohealth/allo-reservation-system/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/suryaps/Documents/Hackathons/allohealth/allo-reservation-system/.claude/get-shit-done/templates/VALIDATION.md`
