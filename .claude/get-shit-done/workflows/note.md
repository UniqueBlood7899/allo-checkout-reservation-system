...
- **Global scope**: `/Users/suryaps/Documents/Hackathons/allohealth/allo-reservation-system/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/suryaps/Documents/Hackathons/allohealth/allo-reservation-system/.claude/notes/`)
...
2. Glob `/Users/suryaps/Documents/Hackathons/allohealth/allo-reservation-system/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/suryaps/Documents/Hackathons/allohealth/allo-reservation-system/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/suryaps/Documents/Hackathons/allohealth/allo-reservation-system/.claude/notes/` — works in any directory
