...
The keys live in `.claude/settings.json` (project) or `/Users/suryaps/Documents/Hackathons/allohealth/allo-reservation-system/.claude/settings.json` (global) — **not** in `.planning/config.json`:
